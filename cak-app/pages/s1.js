...
const S = {
  page: { minHeight: '100vh', background: '#000', color: '#fff', fontFamily: 'var(--font)' },
  hdr: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 20px 16px', borderBottom: '1px solid #1a1a1a' },
  eyebrow: { fontSize: 9, letterSpacing: '.18em', textTransform: 'uppercase', color: 'var(--gmd)', fontFamily: 'var(--mono)' },
  unit: { fontSize: 26, fontWeight: 900, marginTop: 6, letterSpacing: '-.02em' },
  role: { fontSize: 11, color: 'var(--gmd)', marginTop: 2 },
  ...
  statLabel: { fontSize: 9, letterSpacing: '.16em', textTransform: 'uppercase', color: 'var(--gmd)', marginTop: 6, fontFamily: 'var(--mono)' },
  ...
  meta: { fontSize: 11, color: 'var(--gmd)', marginTop: 3 },
  dates: { fontSize: 10, color: 'var(--gmd)', marginTop: 3, fontFamily: 'var(--mono)' },
  ...
  empty: { padding: '48px 0', textAlign: 'center', color: 'var(--gmd)', fontSize: 13 },
