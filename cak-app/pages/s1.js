...
const S = {
  ...
  eyebrow: { fontSize: 9, letterSpacing: '.18em', textTransform: 'uppercase', color: '#fff', fontFamily: 'var(--mono)' },
  unit: { fontSize: 26, fontWeight: 900, marginTop: 6, letterSpacing: '-.02em' },
  role: { fontSize: 11, color: '#fff', marginTop: 2 },
  ...
  statLabel: { fontSize: 9, letterSpacing: '.16em', textTransform: 'uppercase', color: '#fff', marginTop: 6, fontFamily: 'var(--mono)' },
  ...
  meta: { fontSize: 11, color: '#fff', marginTop: 3 },
  dates: { fontSize: 10, color: '#fff', marginTop: 3, fontFamily: 'var(--mono)' },
  ...
  empty: { padding: '48px 0', textAlign: 'center', color: '#fff', fontSize: 13 },
